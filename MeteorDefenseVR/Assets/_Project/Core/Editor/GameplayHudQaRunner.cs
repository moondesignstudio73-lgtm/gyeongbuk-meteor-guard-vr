...
namespace MeteorDefenseVR.Editor
{
    ...
    public static class GameplayHudQaRunner
    {
        ...
        public static void RunEditModeRegression()
        {
            ...
            testApi.Execute(new ExecutionSettings(new Filter
            {
                ...
                testNames = new[]
                {
                    ...
                    "MeteorDefenseVR.Tests.TargetReleaseRegressionTests.LockedMeteorDestructionImmediatelyClearsEveryTargetPresentation",
                    "MeteorDefenseVR.Tests.TargetReleaseRegressionTests.ResetWhileLockedClearsPoolStateBeforeReuse",
        ...
        private static void ValidateScreenLayout(GameplayHudOverlayView view, string direction)
        {
            ...
            if (view.ScoreValue.text != "999,999" || view.AsteroidValue.text != "남은 운석  99 / 100" || view.DifficultyStageValue.text != "EXTREME  ·  STAGE 99")
        ...
        private static void Finish()
        {
            ...
            File.WriteAllLines("Docs/GameplayHudQA/six-direction-validation.txt", new[]
            {
                ...
                "Stress values: EXTREME · STAGE 99 / 남은 운석 99 / 100 / SCORE 999,999",
